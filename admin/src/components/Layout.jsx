...
import { LayoutDashboard, MessageSquare, Settings, Code, LogOut, Coins, Package, BarChart3, Shield, Calendar, Bike, Wrench, Lock, Mountain, ClipboardList, Star } from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/reviews', label: 'Recenzie', icon: Star, showForTenants: ['58718bb0-84dd-4024-b9af-2815b2505afc'] },
  ]
